...
// Success 响应 200 和预设 【操作成功】的JSON数据
...
// BadRequest 响应 400，未传参 msg 时使用默认消息
...
// ValidationError 处理表单验证不通过的错误，返回的JSON 示例
//
//	{
//			"errors": {
//				"phone":[
